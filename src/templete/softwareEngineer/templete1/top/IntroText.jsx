...
function IntroText({ professionTitle, aboutDetails }) {
  return (
    <>
      <h1 className="text-6xl font-semibold tracking-normal capitalize leading-[64px] text-slate-700 max-md:max-w-full max-md:text-4xl max-md:leading-[52px]">
        ...
        <br />
        <span className="text-5xl">{professionTitle}</span>
      </h1>
        ...
        {aboutDetails ? (
          ...
          <>
            ...
            <span className="text-black">
              , a developer dedicated to making the world a better place one
